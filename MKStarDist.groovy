 ...
 * 
 * Adapted from the original version by Lilly-Flore Celma
 */
...
def modelPath = "/home/big/Desktop/MarrowBone/QuPath/models/he_heavy_augment.pb"
...
//    .createAnnotations()         // Create annotations
    .constrainToParent(true)     // Prevent nuclei/cells expanding  beyond any parent annotations
    .classify("nuclei")          // Classify annotations to nuclei
    .build()
	 
// Define which objects will be used as the 'parents' for detection
// Use QP.getAnnotationObjects() if you want to use all annotations, rather than selected objects QP.getSelectedObjects()
// Only select the MK
def pathObjects = QP.getDetectionObjects() /*getAnnotationObjects().findAll { 
