...
//                .preprocess(ImageOps.Filters.gaussianBlur(1)) // Optional preprocessing QuPath Ops
                .epochs(200)             // Optional: will default to 500
...
//                .learningRate(0.2)       // Optional: Will default to 0.2
                ...
                .minTrainMasks(0)        // Optional: Will default to 0, allows 0 detection
...
//                .modelDirectory( new File("/home/big/Desktop/MarrowBone/MKProject/Common/models")) // Optional place to store resulting model. Will default to QuPath project root, and make a 'models' folder
